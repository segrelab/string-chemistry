...
```{r}
env_fit <- lm(Growth ~ Environment, data = filter(data, Biomass == "baa+aaabb+aaba->"))
summary(env_fit)
```
...
Each biomass reaction is a significant predictor of growth. The Nagelkerke R-squared and C-statistic for this model are real values now, but they're both bad: 0.083 on a scale of 0 to 1 is terrible and an AUC of 0.773 is mediocre.
